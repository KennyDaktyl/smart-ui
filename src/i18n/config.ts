    ...
    translation: {
      ...
      providers: {
        ...
        telemetry: {
          ...
          rceSettlementPrice: "Cena RCE dla aktywnego interwału",
          rceForecastPrice: "Prognozowana cena energii",
          rceMatchedRevenue: "Przychód dopasowany do interwałów",
          rceValidInterval: "Obowiązuje",
          rceForecastUpdatedAt: "Aktualizacja prognozy: {{value}}",
          rceMatchedRevenueHint:
            "Energia {{energy}}, dopasowane interwały: {{count}}",
          rceSettlementChart: "Wykres ceny RCE",
          rceForecastChart: "Wykres prognozy ceny",
          hourlyChart: "Produkcja godzinowa (słupki)",
          hourlyRevenueLine: "Przychód godzinowy RCE (linia)",
          energyLabel: "Energia",
      ...
      dashboard: {
        ...
        cards: {
          ...
          provider: "Provider",
          dependencyTitle: "Zależność",
          dependencyMode: "Urządzenie zależne",
          dependencyForcedOn: "Włączone przez zależność",
          dependencyForcedOff: "Wyłączone przez zależność",
          modeSummary: "Aktywna logika",
    ...
    translation: {
      ...
      providers: {
        ...
        telemetry: {
          ...
          rceSettlementPrice: "RCE price for the active interval",
          rceForecastPrice: "Forecast energy price",
          rceMatchedRevenue: "Revenue matched to time intervals",
          rceValidInterval: "Valid for",
          rceForecastUpdatedAt: "Forecast updated: {{value}}",
          rceMatchedRevenueHint:
            "Energy {{energy}}, matched intervals: {{count}}",
          rceSettlementChart: "RCE price chart",
          rceForecastChart: "Forecast price chart",
          hourlyChart: "Hourly production (bars)",
          hourlyRevenueLine: "Hourly RCE revenue (line)",
          energyLabel: "Energy",
      ...
      dashboard: {
        ...
        cards: {
          ...
          dependencyMode: "Dependent device",
          dependencyForcedOn: "Turned on by dependency",
          dependencyForcedOff: "Turned off by dependency",
          modeSummary: "Active logic",
